...
//TODO: Document what this class really does
...
protected:
	static unsigned long long FindPatternFast(const char* pattern, const char* mask, unsigned long long base, unsigned __int64 size);
	static unsigned long long FindPatternSafe(const char* pattern, const char* mask, unsigned long long base, unsigned __int64 size);
...
bool Hook<Ret, Args...>::Init() {
	...
	if (FunctionPointer == 0) {
		...
		{
			case FAST:
				FunctionPointer = FindPatternFasr(pattern, mask, tbase, tsize);
				break;
			case SAFE:
				FunctionPointer = FindPatternSafe(pattern, mask, tbase, tsize);
				break;
			case ALL:
...
template<typename Ret, typename ...Args>
inline unsigned long long Hook<Ret, Args...>::FindPatternFast(const char* pattern, const char* mask, unsigned long long base, unsigned __int64 size)
{
...
template<typename Ret, typename ...Args>
inline unsigned long long Hook<Ret, Args...>::FindPatternSafe(const char* pattern, const char* mask, unsigned long long base, unsigned __int64 size)
{
