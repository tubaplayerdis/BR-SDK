...
public:
	void AddInteractionWidget(class UInteractionWidget* Widget_AddInteractionWidget);
	void AddCrosshairWidgets(const TArray<class UMapCrosshairWidget*>& Widgets_AddCrosshairWidgets);
