...
public:
	...
	TSoftObjectPtr<class UTexture2D>              K2Node_Event_IconTexture;                          // 0x0020(0x0028)(ConstParm, UObjectWrapper, HasGetValueTypeHash)
	EBrickUIColorStyle                            K2Node_Event_NewStyle;                             // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_CustomEvent_MinValue;                       // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_MaxValue;                       // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ENumericValueType                             K2Node_CustomEvent_ValueType;                      // 0x0054(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_CustomEvent_InFormat;                       // 0x0060(0x0018)(ConstParm)
};
